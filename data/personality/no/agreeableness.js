...
interesser over det å komme overens med andre. De er generelt ikke så
opptatt av andres ve og vel, og vil derfor ikke strekke seg langt for andre
mennesker. Noen ganger er det deres skepsis når det gjelder andres motiver
som forårsaker deres mistenksomhet, uvennlighet og mangel på samarbeidsvilje.
Medmenneskelighet er svært fordelaktig for å bli populær og for å fortsette å
være det. Medmenneskelige individer er bedre likt enn de som er lite
medmenneskelig. Men medmenneskelighet er ingen nyttig egenskap i situasjoner
der det kreves at man tar tøffe og helt objektive beslutninger.
Lite medmenneskelige individer kan bli dyktige vitenskapsmenn, kritikere eller
soldater.`,
  results: [
    {
      score: 'negative',
...
ærlige, åpne og oppriktige. De som skårer lavt mener at det kan være nødvendig
...
hele sannheten. Ditt resultat på moral er {{score}}.`
    },
    {
      facet: 3,
      title: 'Altruisme',
      text: `Altruistiske mennesker ser det å hjelpe andre mennesker
som belønning i seg selv. Derfor er de generelt villige til
hjelpe de som er i nød. Altruistiske mennesker synes at det å gjøre
...
altruisme er {{score}}`
    },
    {
      facet: 4,
      title: 'Føyelighet',
      text: `Individer som skårer høyt på denne fasetten misliker
...
som ubehagelig arrogante av andre. Ditt resultat på beskjedenhet er {{score}}`
    },
    {
      facet: 6,
      title: 'Følsomhet',
      text: `Individer som skårer høyt på denne fasetten er medfølende og
