...
De liker å snakke i grupper, hevde seg selv og rette oppmerksomhet
mot seg selv.

De introverte mangler livligheten, energien og aktivitesnivået til
de ekstroverte. De er ofte stille, nedstemte, forsiktige og lite
engasjert i den sosiale verden. Deres mangel på sosialt engasjement
bør ikke tolkes som reserverthet eller depresjon; den introverte
trenger bare mindre stimulering enn den ekstroverte og foretrekker å
være alene. Uavhengigheten og reservasjonen til den introverte er
noen ganger feilaktig sett på som uvennlighet eller arroganse.
I virkeligheten er en introvert som skårer høyt på
  ...
  facets: [
    {
      facet: 1,
      title: 'Vennlighet',
      text: `Vennlige mennesker liker andre mennesker og viser åpent positive
...
oppfattet som distanserte og reserverte.`
    },
    {
      facet: 2,
      title: 'Sosiabilitet',
      text: `Personer med høy sosiabilitet setter pris på andres selskap og
finner det stimulerende og får mye ut av det. De synes det er spennende
...
støy og bråk og oppsøker ikke fart og spenning.`
    },
    {
      ...
      text: `Denne fasetten måler positive humørsvingninger og
